...
/*   Updated: 2023/10/27 15:23:58 by acaceres         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	fractol->color_palette.colors[0].color1 = 0x00EDF7FA;
	fractol->color_palette.colors[0].color2 = 0x00FF502F;
	...
	fractol->color_palette.colors[7].color1 = 0x001B1A17;
	fractol->color_palette.colors[7].color2 = 0x00CF7500;
	fractol->color_palette.colors[8].color1 = 0x00FDF6EC;
	fractol->color_palette.colors[8].color2 = 0x00F0A500;
	fractol->color_palette.colors[9].color1 = 0x00FF0000;
	fractol->color_palette.colors[9].color2 = 0x00000000;
	fractol->color_palette.colors[10].color1 = 0x0039065A;
	fractol->color_palette.colors[10].color2 = 0x00EA0599;
}
